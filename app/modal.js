...
showChangelog: function() {
    const html = `
        ...
        <!-- CHANGELOG -->
                    <div class="font-bold text-green-400">v0.8.174 (aktuell) - 24.09.2026</div>
                    <div>&#8226; NEU: Ligapyramide ueber den Knopf in der Liga-Navigation, alle Ligen jeder Saison seit 1949/50</div>
                    <div class="font-bold text-slate-400">v0.8.173 - 24.09.2026</div>
                    ...
                    <div>&#8226; NEU: Europapokal-Startplaetze in allen Archivsaisons ab 1963/64 - je Saison recherchiert statt nach heutiger Regel geschaetzt</div>
                    <div>&#8226; NEU: Wer als Meister an der Aufstiegsrunde scheiterte, ist in der Archivtabelle markiert</div>
                    <div>&#8226; FIX: Fuer eine Liga, die es damals nicht gab, werden keine fremden Ligen mehr als ihre unteren ausgegeben</div>
                    <div class="font-bold text-slate-400">v0.8.171 - 20.09.2026</div>
                    <div>&#8226; FIX: 3. Liga, Regionalligen und Oberligen zeigten keine Rekorde - der Backfill sah ihre Saisons vor dem Sim-Start nicht (3 statt 23 Ligen)</div>
                    <div>&#8226; FIX: Die Relegations-Chronik der 3. Liga und der Regionalligen begann erst 2025/26 - die historischen Aufstiegsduelle fehlten in der Datenbank und trugen keine Herkunftsliga</div>
                    <div>&#8226; NEU: Die Siegerliste zeigt, was aus dem Meister wurde - direkt aufgestiegen, ueber die Relegation oder kein Aufstieg</div>
                    <div>&#8226; NEU: Wer als Meister nicht aufstieg, traegt die Begruendung aus der Quelle (Verzicht, fehlende Lizenz, zweite Mannschaft)</div>
                    <div>&#8226; NEU: Aufstiegsduelle nennen die Herkunftsliga beider Teilnehmer</div>
                    <div class="font-bold text-slate-400">v0.8.170 - 20.09.2026</div>
                    ...
                    <div>&#8226; NEU: Pruefung dass im Pokal kein Ergebnis gedeckelt ist - ein Deckel ist am Hoechstwert nicht zu erkennen, sondern nur daran dass sich Ergebnisse auf einer Zahl stapeln</div>
                    <div class="font-bold text-slate-400">v0.8.147 - 06.09.2026</div>
                    ...
                    <div>&#8226; NEU: Remis- und Heimsiegquote je Ebene aus echten Spielen als Messlatte, tor_kalib prueft Torschnitt, Verteilung und Balance in einem Lauf</div>
                    <div class="font-bold text-slate-400">v0.8.145 - 06.09.2026</div>
                    ...
                    <div class="font-bold text-slate-400">v0.8.134 - 01.09.2026</div>
                    ...
                    <div class="font-bold text-slate-400">v0.8.130 - 30.08.2026</div>
                    <div>&#8226; NEU: Gemeinsames Tor-Modell fuer Liga und alle Pokale - je tiefer die Spielklasse desto mehr Tore, weil die Defensive schlechter ist (1. Bundesliga 3,2 und Landesliga 4,5 Tore pro Spiel wie in der Realitaet)</div>
                    <div>&#8226; FIX: In der Liga war 4:0 das hoechstmoegliche Ergebnis ueberhaupt, die Torzahl wurde gleichverteilt aus 1 bis 4 gezogen. Jetzt entscheiden Klassenunterschied und Wahrscheinlichkeit gemeinsam</div>
                    <div>&#8226; NEU: Remis-Korrektur in der Liga, damit die Unentschieden-Quote trotz deutlich mehr Toren realistisch bleibt. Meisterpunkte und Heimsiegquote bleiben unveraendert</div>
                    <div>&#8226; NEU: Die letzten drei Versions-Snapshots bleiben jetzt im Projekt liegen statt nur einer</div>
                    <div class="font-bold text-slate-400">v0.8.129 - 30.08.2026</div>
                    <div>&#8226; NEU: Deutlich mehr Text-Abwechslung – Kontext-Schlagzeilen, Vorschau, Pressestimmen, Serien-Texte und Pokal-Schlagzeilen kraeftig ausgebaut (883 statt 564 Zeilen)</div>
                    <div class="font-bold text-slate-400">v0.8.128 - 30.08.2026</div>
                    ...
                    <div class="font-bold text-slate-400">v0.8.126 - 30.08.2026</div>
                    ...
                    <div class="font-bold text-slate-400">v0.8.120 - 28.08.2026</div>
                    ...
                    <div>&#8226; FIX: TBS Pinneberg und Tuerk-Birlikspor Pinneberg waren derselbe Verein - Doppeleintrag entfernt</div>
                    <div>&#8226; FIX: Ligalose Geistervereine aus Altspielstaenden werden beim Laden entfernt</div>
                    <div class="font-bold text-slate-400">v0.8.109 - 23.08.2026</div>
                    ...
                    <div>&#8226; NEU: Bayern, HSV, 1. FCK, Union, Darmstadt, Holstein Kiel und 38 weitere Wappen in HD</div>
                    <div>&#8226; FIX: FM-Zuordnung - Spitzenvereine stehen dort unter dem nackten Ortsnamen</div>
                    <div class="font-bold text-slate-400">v0.8.104 - 23.08.2026</div>
